            ...
            <div className="mx-auto flex max-w-6xl flex-col gap-6">
                ...
                <section className="rounded-3xl bg-white p-6 shadow-sm ring-1 ring-slate-200">
                    ...
                    <h2 className="mt-2 text-xl font-bold">
                        Question Bank Management Shell
                    </h2>

                    <p className="mt-3 text-sm leading-6 text-slate-600">
                        This protected admin page is ready. Next, we will connect
                        it to <span className="font-semibold">/api/questions</span>{" "}
                        for MCQ listing, creation, editing, disabling, and optional
                        question group attachment.
                    </p>

                    <div className="mt-5 rounded-2xl bg-blue-50 p-4 text-sm text-blue-900 ring-1 ring-blue-100">
                        No question data is loaded yet. API integration will be
                        added in the next step after this shell is verified.
                    </div>
                </section>
            </div>
        </main>
