...
const buildQuestionSnapshot = (question, section, order) => {
    return {
        ...
        pyqDetails: question.pyqDetails,
        evaluationStatus: question.evaluationStatus || "scored",
        evaluationNoteEn: question.evaluationNoteEn,
        evaluationNoteHi: question.evaluationNoteHi,
